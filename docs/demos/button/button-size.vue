<template>
  <p style="margin-bottom: 10px;">
    ...
    <s-button style="--s-button-size-text: 14px;--s-button-padding: 14px 24px;">custom</s-button>
  </p>
  <p style="margin-bottom: 10px;">
    <s-button round size="small">small</s-button>
    <s-button round>normal</s-button>
    <s-button round size="large">large</s-button>
    <s-button round style="--s-button-size-text: 14px;--s-button-padding: 14px 24px;">custom</s-button>
  </p>
  <p>
